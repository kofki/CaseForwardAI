...
export const ActionCardSchema = z.object({
    ...
    reasoning: z.string(),
    metadata: z.object({
        emailBody: z.string().optional().describe("Draft email body if action is DRAFT_EMAIL"),
        missingDocs: z.array(z.string()).optional().describe("List of missing documents if action is REQUEST_DOCUMENTS"),
